...
function Heels() {
  const [carouselDate, setCarouselData] = useState([
    {
      url: "https://cdna.lystit.com/1200/630/tr/photos/shoppremiumoutlets/1c96fc08/naturalizer-multi-Wave-Woven-Block-Heels.jpeg",
      label: "Street Ready",
      description: "Comfort meets performance in every step."
    },
    {
      url: "https://tse4.mm.bing.net/th/id/OIP.fAPLeGoJNj7h_O7GHvNsDgHaDE?cb=ucfimg2&ucfimg=1&rs=1&pid=ImgDetMain&o=7&rm=3",
      label: "Elegant Edge",
      description: "A perfect blend of style and support."
    },
    {
      url: "https://i0.wp.com/primewomen.com/wp-content/uploads/2021/08/ERIJUNOR-Pointy-Toe-Mid-Heels-Pumps.jpg?ssl=1",
